                ...
                >
                    ...
                    <div class="flex-none flex items-center space-x-4">
                        ...
                        <div
                            ...
                            class="inline-flex items-center ring-1 ring-inset text-sm truncate font-medium px-2 py-1 rounded bg-zinc-100 dark:bg-zinc-900 text-zinc-500 dark:text-zinc-400 ring-zinc-300 dark:ring-zinc-700 space-x-1 p-4"
                        >
